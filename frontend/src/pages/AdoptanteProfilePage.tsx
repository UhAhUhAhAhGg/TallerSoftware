...
export default function AdoptanteProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        // Redirigir al dashboard del adoptante
    ...
    <div className="profile-container">
      <div className="profile-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <section className="form-section">
            <h2>Experiencia con Animales</h2>
            ...
            {formData.exp_previa && (
              <div className="form-group">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Cuentanos sobre tu experiencia con mascotas..."
                  rows={4}
                />
              </div>
            )}
          ...
          <section className="form-section">
            <h2>Preferencias para tu Nueva Mascota</h2>
            ...
            <div className="form-group">
              ...
              >
                ...
                {especies.map((especie) => (
                  <option key={especie.id_espe} value={especie.id_espe}>
                    {especie.nom_espe}
                  </option>
                ))}
              </select>
            ...
            <div className="form-group checkbox-group">
              <label>
                <input
                  ...
                  onChange={handleChange}
                />
                <span>¿Aceptas mascotas que se llevan bien con niños?</span>
              </label>
            </div>
            ...
            <div className="form-group checkbox-group">
              <label>
                <input
                  ...
                  onChange={handleChange}
                />
                <span>¿Aceptas mascotas que se lleven bien con otros animales?</span>
              </label>
            </div>
          </section>
